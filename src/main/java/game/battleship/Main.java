...
public class Main {
    public static void main(String[] args) {
        ...
        String sessionId = gameService.initBotGame(6, 2);
        gameService.addShip(sessionId, "SH1", 2, CoordinateUtils.fromInts(0, 0, 3, 1));
        gameService.addShip(sessionId, "SH2", 1, CoordinateUtils.fromInts(2, 2, 5, 0));
        gameService.addShip(sessionId, "SH3", 2, CoordinateUtils.fromInts(0, 3, 4, 4));
